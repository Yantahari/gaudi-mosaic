...
export default {
  ...
  // ---- SEO（動的メタタグ） ----
  seo: {
    title: 'ガウディ・モザイク — トレンカディス・クリエイター | 無料デジタルアート',
    description: 'アントニ・ガウディのトレンカディス技法でデジタルモザイクを作ろう。グエル公園、カサ・バトリョ、サグラダ・ファミリアにインスピレーションを得た無料アプリ。ガウディ没後100周年記念 2026年。バルセロナ発。',
    ogTitle: 'ガウディ・モザイク — トレンカディス・クリエイター',
    ogDescription: 'アントニ・ガウディのトレンカディス技法でデジタルモザイクを作ろう。没後100周年記念の無料ウェブアプリ。',
    ogImageAlt: 'ガウディ・モザイク — カラフルなトレンカディスの陶器の破片がアプリタイトルを囲む'
  },
